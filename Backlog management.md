...
### ⚙️ Regional Consumption Window Logic
...
* **Japan, HK, ANZ:** Monthly Rolling Window (-1 to +3 weeks). Order pattern is monthly/bi-weekly rolling orders instead of bulk quarterly.
...
* **System Formula:** Triggers a shift from "Forecast + Order" to: `Total System Demand = Actual Orders + Remaining Forecast`
...
* **Rolling Order Pattern (JP/ANZ/HK) ➔ Monthly Rolling Consumption (-1 to +3 Weeks):** Orders are placed on a monthly or bi-weekly rolling basis. The system consumes forecast within a window of W-1 to W+3.
